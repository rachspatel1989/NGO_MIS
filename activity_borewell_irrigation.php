...
include_once './activity_borewell_irrigation_insert.php';
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="activity">
                                            ...
                                            <form action="#" method="post">
                                                <!-- Rice Cultivation -->
                                                <div class="GroupBorewellIrrigationScheme">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Water Resource Development M) Group Bore well Irrigation Scheme</h6>
                                                            ...
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if ($cnt == 0) {
                                                                        ?>
                                                                        <tr id="hidedataA1">  
                                                                            <td style="width: 300px">Is group formed with 03 farmers for group well? <input type="hidden" id="L1" name="L1" value="Is group formed with 03 farmers for group well? " class="form-control"></td>
                                                                ...
                                                                if ($cnt == 2) {
                                                                    ?>
                                                                    <tr id="hidedataA3">  
                                                                        <td style="width: 300px">Is done Microfinance appraisal for Group bore well intervention?<input type="hidden" id="L3" name="L3" value="Is done Microfinance appraisal for Group well intervention?" class="form-control"></td>
                                                                        <td> 05 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA3">  
                                                                    <td colspan="5">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="microfinance_amount" id="microfinance_amount" placeholder="Microfinance Amount" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4"></div>
                                                                        </div>
                                                                ...
                                                                if ($cnt == 3) {
                                                                    ?>
                                                                    <tr id="hidedataA4">  
                                                                        <td style="width: 300px">Is legal documents has been prepared?<input type="hidden" id="L4" name="L4" value="Is legal documents has been prepared?" class="form-control"></td>
                                                                        <td> 05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 4) {
                                                                    ?>
                                                                    <tr id="hidedataA5">  
                                                                        <td style="width: 300px">The beneficiary got the approval of concern authority of DBMGF for intervention??<input type="hidden" id="L5" name="L5" value="The beneficiary got the approval of concern authority of DBMGF for intervention?" class="form-control"></td>
                                                                        <td> 05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 6) {
                                                                    ?>
                                                                    <tr id="hidedataA7">  
                                                                        <td style="width: 300px">Is work started and done appointment of agency?<input type="hidden" id="L7" name="L7" value="Is work started and done appointment of agency?" class="form-control"></td>
                                                                        <td> 05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 7) {
                                                                    ?>
                                                                    <tr id="hidedataA8">  
                                                                        <td style="width: 300px">Is water available in bore well? Verified with Block coordinator.<input type="hidden" id="L8" name="L8" value="Is water available in bore well? Verified with Block coordinator." class="form-control"></td>
                                                                        <td> 05 days </td>
                                                                        <td>
