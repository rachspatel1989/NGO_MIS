...
include_once './activity_cattle_induction_insert.php';
                                                ...
                                                <div class="RicecultivationwithSRI">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Animal Husbandry G) Cattle Induction</h6>
                                                        ...
                                                        <div class="form-group">
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                if ($cnt == 1) {
                                                                    ?>
                                                                    <tr id="hidedataA2">  
                                                                        <td style="width: 300px">Is done Micro-finance appraisal?<input type="hidden" id="L2" name="L2" value="Is done Micro-finance appraisal?" class="form-control"></td>
                                                                ...
                                                                if ($cnt == 2) {
                                                                    ?>
                                                                    <tr id="hidedataA3">  
                                                                        <td style="width: 300px">Is dairy management training given to farmers?<input type="hidden" id="L3" name="L3" value="Is dairy management training given to farmers?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 3) {
                                                                    ?>
                                                                    <tr id="hidedataA4">  
                                                                        <td style="width: 300px">Expected contribution / Margin money from the beneficiary is received, receipt issued to the Beneficiary.<input type="hidden" id="L4" name="L4" value="Expected contribution / Margin money from the beneficiary is received, receipt issued to the Beneficiary." class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 4) {
                                                                    ?>
                                                                    <tr id="hidedataA5">  
                                                                        <td style="width: 300px">Disbursement of loan by micro-finance team?<input type="hidden" id="L5" name="L5" value="Disbursement of loan by micro-finance team?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 5) {
                                                                    ?>
                                                                    <tr id="hidedataA6">  
                                                                        <td style="width: 300px">Is Cattle purchased by Farmers?<input type="hidden" id="L6" name="L6" value="Is Cattle purchased by Farmers?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA6">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. Which Cattle - Cow/Buffaloes</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>2. Variety of cattle</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="cattle" id="cattle" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="cattle_variety" id="cattle_variety" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                ...
                                                                if ($cnt == 6) {
                                                                    ?>
                                                                    <tr id="hidedataA7">  
                                                                        <td style="width: 300px">Is cattle insurance done?<input type="hidden" id="L7" name="L7" value="Is cattle insurance done?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA7">  
                                                                    <td colspan="5">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="insurance_amt" id="insurance_amt" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4"></div>
                                                                        </div>
