...
// receiving the post params
    ...
    if ($cnt == 0) {
        ...
        $species_name = $_POST['cattle'];
        $variety = $_POST['cattle_variety'];

        $result = $db->insertActivityTracker($login_id, $family_id, $allocate_id, $benificiary_id, $indicator, $action, $visit, $remark, $ip, $date, $timestamp);
        $query1 = mysql_query("INSERT INTO activity_progress_details_master(login_id,beneficiary_id,dbmgf_grant,farmers_contribution,mf_grant,nabard,other_grants,species_name,variety,reg_via,reg_device_id,reg_created_date,reg_timestamp) VALUES('$login_id','$benificiary_id','$dbmgf','$farmercont','$mf','$nabard','$othergrant','$species_name','$variety','$reg_via','$ip',STR_TO_DATE('$date','%m/%d/%Y%h:%i'),'$timestamp')");
        ...
        $reg_via = "Web";
        $insurance_amt = $_POST['insurance_amt'];
