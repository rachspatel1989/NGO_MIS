...
$db = new DB_Functions();
include_once './activity_credit_support_insert.php';
                                                ...
                                                <div class="RicecultivationwithSRI">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Non-Farm Sector L) Credit Support for self-employment</h6>
                                                            ...
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if ($cnt == 0) {
                                                                        ?>
                                                                        <tr id="hidedataA1">  
                                                                            <td style="width: 300px">Micro-finance credit appraisal.<input type="hidden" id="L1" name="L1" value="Micro-finance credit appraisal." class="form-control"></td>
                                                                        ...
                                                                        while ($activity_row = mysql_fetch_array($activity_sql)) {
                                                                            ...
                                                                            echo "<td><input name='A1' type='radio' id='pendingYesA1' value='Pending'> Pending <br/><input name='A1' type='radio' id='completedYesA1' checked='checked' value='Completed'> Completed <br/><input name='A1' type='radio' id='terminatedYesA1' checked='checked' value='Terminate'> Terminate </td>";
                                                                        }
                                                                        ?>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 1) {
                                                                    ?>
                                                                    <tr id="hidedataA2">  
                                                                        <td style="width: 300px">The beneficiary got the approval of concern authority of DBMGF for enterprise:<input type="hidden" id="L2" name="L2" value="The beneficiary got the approval of concern authority of DBMGF for enterprise:" class="form-control"></td>
                                                                ...
                                                                if ($cnt == 2) {
                                                                    ?>
                                                                    <tr id="hidedataA3">  
                                                                        <td style="width: 300px">Expected contribution / Margin money from the beneficiary is received, receipt issued to the Beneficiary and contribution deposited into DBMGF account.<input type="hidden" id="L3" name="L3" value="Expected contribution / Margin money from the beneficiary is received, receipt issued to the Beneficiary and contribution deposited into DBMGF account." class="form-control"></td>
                                                                        <td>15 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA3">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>1. Amount of Contribution  </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>2. Name of Activity (Business/ Enterprise)</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="amount_contribution" id="amount_contribution" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                ...
                                                                if ($cnt == 3) {
                                                                    ?>
                                                                    <tr id="hidedataA4">  
                                                                        <td style="width: 300px">Is loan disbursed by Micro-finance team?<input type="hidden" id="L4" name="L4" value="Is loan disbursed by Micro-finance team?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 4) {
                                                                    ?>
                                                                    <tr id="hidedataA5">  
                                                                        <td style="width: 300px">Is insurance of borrower done?<input type="hidden" id="L5" name="L5" value="Is insurance of borrower done?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 5) {
                                                                    ?>
                                                                    <tr id="hidedataA6">  
                                                                        <td style="width: 300px">Is completed physical verification to ensure that the planned enterprise is established/ developed existing one?<input type="hidden" id="L6" name="L6" value="Is completed physical verification to ensure that the planned enterprise is established/ developed existing one?" class="form-control"></td>
                                                                        <td>15 days </td>
                                                                        <td>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <select name="enterprise" id="enterprise" class="form-control">
                                                                                    ...
                                                                                    <option value="Enterprise is running well">Enterprise is running well</option>
                                                                                    <option value="Enterprise not running well">Enterprise not running well</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4"></div>
