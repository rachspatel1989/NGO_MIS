...
$db = new DB_Functions();
include_once './activity_goat_rearing_insert.php';
                                                ...
                                                <div class="RicecultivationwithSRI">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Animal Husbandry I) Goat Rearing</h6>
                                                            ...
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if ($cnt == 0) {
                                                                        ?>
                                                                        <tr id="hidedataA1">  
                                                                            <td style="width: 300px">Is approval of concern authority of DBMGF for intervention?<input type="hidden" id="L1" name="L1" value="Is approval of concern authority of DBMGF for intervention?" class="form-control"></td>
                                                                ...
                                                                if ($cnt == 1) {
                                                                    ?>
                                                                    <tr id="hidedataA2">  
                                                                        <td style="width: 300px">Is Goat rearing management training given to farmers?<input type="hidden" id="L2" name="L2" value="Is Goat rearing management training given to farmers?" class="form-control"></td>
                                                                ...
                                                                if ($cnt == 2) {
                                                                    ?>
                                                                    <tr id="hidedataA3">  
                                                                        <td style="width: 300px">Is Construction of Goat shed done by the beneficiary as his/her contribution for the activity?<input type="hidden" id="L3" name="L3" value="Is Construction of Goat shed done by the beneficiary as his/her contribution for the activity?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 3) {
                                                                    ?>
                                                                    <tr id="hidedataA4">  
                                                                        <td style="width: 300px">Expected contribution from the beneficiary is received, receipt issued to the farmer and deposited to DBMGF account.<input type="hidden" id="L4" name="L4" value="Expected contribution from the beneficiary is received, receipt issued to the farmer and deposited to DBMGF account." class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 4) {
                                                                    ?>
                                                                    <tr id="hidedataA5">  
                                                                        <td style="width: 300px">Is done Support of Goats?<input type="hidden" id="L5" name="L5" value="Is done Support of Goats?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA5">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>1. Nos. of Goat supported  </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>2. Variety of Goat</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="nos_goat" id="nos_goat" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="variety_goat" id="variety_goat" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <br/>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>3. Amount of Beneficiary contribution</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>4. DBMGF Grant</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="beneficiary_amount" id="beneficiary_amount" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="dbmgf_grant" id="dbmgf_grant" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <br/>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>5. Contribution of Farmers</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>6. Microfinance</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="farmers_contribution" id="contribution_farmers" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="mf" id="microfinance" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <br/>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>7. NABARD</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>8. Others</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="othersB6" id="others" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                if ($cnt == 5) {
                                                                    ?>
                                                                    <tr id="hidedataA6">  
                                                                        <td style="width: 300px">Is done Insurance of Goat?<input type="hidden" id="L6" name="L6" value="Is done Insurance of Goat?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA6">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. Amount of Insurance  </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4"></div>
                                                                        </div>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="amount_insurance" id="amount_insurance" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4"></div>
                                                                        </div>
                                                                ...
                                                                if ($cnt == 6) {
                                                                    ?>
                                                                    <tr id="hidedataA7">  
                                                                        <td style="width: 300px">Is Verification done for Vaccination and recommended feed dose given to the Goat?<input type="hidden" id="L7" name="L7" value="Is Verification done for Vaccination and recommended feed dose given to the Goat?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA7">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. Nos of Goats survival  </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4"></div>
                                                                        </div>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="nos_goats" id="nos_goats" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4"></div>
                                                                        </div>
