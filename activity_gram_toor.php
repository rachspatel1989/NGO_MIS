...
$db = new DB_Functions();
include_once './activity_gram_toor_insert.php';
                                                ...
                                                <div class="RicecultivationwithSRI">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Agriculture C) Gram/Toor cultivation</h6>
                                                            ...
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                <tr id="opendataA1">  
                                                                    <td colspan="5">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <select name="gram_toor" id="gram_toor" class="form-control">
                                                                                    <option value="null">select</option>
                                                                                    <option value="Gram Cultivation">Gram Cultivation</option>
                                                                                    <option value="Toor Cultivation">Toor Cultivation</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4"></div>
                                                                ...
                                                                if ($cnt == 1) {
                                                                    ?>
                                                                    <tr id="hidedataA2">  
                                                                        <td style="width: 300px">Is Gram / Toor cultivation training given to the farmer/ beneficiary?<input type="hidden" id="L2" name="L2" value="Is Gram / Toor cultivation training given to the farmer/ beneficiary?" class="form-control"></td>
                                                                ...
                                                                <tr id="opendataA6">  
                                                                    <td colspan="5">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="nabard" id="nabard" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="othersB6" id="othersB6" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </td>
