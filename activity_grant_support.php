...
$db = new DB_Functions();
include_once './activity_grant_support_insert.php';
                                                ...
                                                <div class="RicecultivationwithSRI">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Non-Farm Sector: K) Grant Support for self-employment</h6>
                                                            ...
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if ($cnt == 0) {
                                                                        ?>
                                                                        <tr id="hidedataA1">  
                                                                            <td style="width: 300px">Cluster Coordinator has raised demand of beneficiary  (Application for grant, Educational documents, Identity proof, photos, address proof)<input type="hidden" id="L1" name="L1" value="Cluster Coordinator has raised demand of beneficiary  (Application for grant, Educational documents, Identity proof, photos, address proof)" class="form-control"></td>
                                                                ...
                                                                if ($cnt == 1) {
                                                                    ?>
                                                                    <tr id="hidedataA2">  
                                                                        <td style="width: 300px">The beneficiary got the approval of concern authority of DBMGF for intervention:<input type="hidden" id="L2" name="L2" value="The beneficiary got the approval of concern authority of DBMGF for intervention:" class="form-control"></td>
                                                                ...
                                                                if ($cnt == 2) {
                                                                    ?>
                                                                    <tr id="hidedataA3">  
                                                                        <td style="width: 300px">Expected contribution money from the beneficiary is received, receipt issued to the Beneficiary and deposit to DBMGF account.<input type="hidden" id="L3" name="L3" value="Expected contribution money from the beneficiary is received, receipt issued to the Beneficiary and deposit to DBMGF account." class="form-control"></td>
                                                                        <td>10 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 3) {
                                                                    ?>
                                                                    <tr id="hidedataA4">  
                                                                        <td style="width: 300px">Is done support of planned material. (Tool kit/equipment/raw material etc. for enterprise)?<input type="hidden" id="L4" name="L4" value="Is done support of planned material. (Tool kit/equipment/raw material etc. for enterprise)?" class="form-control"></td>
                                                                        <td>10 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 4) {
                                                                    ?>
                                                                    <tr id="hidedataA5">  
                                                                        <td style="width: 300px">Is completed physical verification to ensure that the planned enterprise is established?<input type="hidden" id="L5" name="L5" value="Is completed physical verification to ensure that the planned enterprise is established?" class="form-control"></td>
                                                                        <td>15 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 5) {
                                                                    ?>
                                                                    <tr id="hidedataA6">  
                                                                        <td style="width: 300px">Start the end-line survey<input type="hidden" id="L6" name="L6" value="Start the end-line survey" class="form-control"></td>
                                                                        <td>45 days </td>
                                                                        <td>
