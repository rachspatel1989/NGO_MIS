...
$db = new DB_Functions();
include_once './activity_incomegeneration_insert.php';
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="activity">
                                            ...
                                            <form action="#" method="post">
                                                <!-- Rice Cultivation -->
                                                <div class="IncomeGenerationActivity">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Women Empowerment Q) Income Generation Activity (IGA)</h6>
                                                            ...
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if ($cnt == 0) {
                                                                        ?>
                                                                        <tr id="hidedataA1">  
                                                                            <td style="width: 300px">Is selection of beneficiary done as per eligibility criteria?   <input type="hidden" id="L1" name="L1" value="Is selection of beneficiary done as per eligibility criteria?   " class="form-control"></td>
                                                                ...
                                                                <tr id="opendataA1">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>1. Name of IGA </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>2. Name of SHG </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="iga_name" id="iga_name" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="sgh_name" id="sgh_name" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                if ($cnt == 1) {
                                                                    ?>
                                                                    <tr id="hidedataA2">  
                                                                        <td style="width: 300px">Is proposal prepared and submitted to bank or NABFINCE or Micro finance agency for approval?<input type="hidden" id="L2" name="L2" value="Is proposal prepared and submitted to bank or NABFINCE or Micro finance agency for approval?" class="form-control"></td>
                                                                ...
                                                                if ($cnt == 2) {
                                                                    ?>
                                                                    <tr id="hidedataA3">  
                                                                        <td style="width: 300px">Is training for entrepreneurship development programme completed for IGA?<input type="hidden" id="L3" name="L3" value="Is training for entrepreneurship development programme completed for IGA?" class="form-control"></td>
                                                                        <td> 05 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA3">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. Name of training </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>2. Duration -(In days ) </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>3. Agency & Venue of training </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="training_agency" id="training_agency" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                if ($cnt == 3) {
                                                                    ?>
                                                                    <tr id="hidedataA4">  
                                                                        <td style="width: 300px">Is credit linkage done and amount disbursed to beneficiary account?<input type="hidden" id="L4" name="L4" value="Is credit linkage done and amount disbursed to beneficiary account?" class="form-control"></td>
                                                                        <td> 10 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA4">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. Financial Institute </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>2. Amount of loan (Rs.) </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>3. Rate of Interest (%) </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="financial_institute" id="financial_institute" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="amount_loan" id="amount_loan" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="interest_rate" id="intrest_rate" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        </div> 
                                                                    </td>
                                                                ...
                                                                if ($cnt == 4) {
                                                                    ?>
                                                                    <tr id="hidedataA5">  
                                                                        <td style="width: 300px">Establishment of Income Generation activity as per plan. <input type="hidden" id="L5" name="L5" value="Establishment of Income Generation activity as per plan. " class="form-control"></td>
                                                                        <td> 05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 5) {
                                                                    ?>
                                                                    <tr id="hidedataA6">  
                                                                        <td style="width: 300px">Start the endline survey<input type="hidden" id="L6" name="L6" value="Start the endline survey" class="form-control"></td>
                                                                        <td> 45 days </td>
                                                                        <td>
