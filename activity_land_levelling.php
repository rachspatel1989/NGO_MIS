...
$db = new DB_Functions();
include_once './activity_land_levelling_insert.php';
                                                ...
                                                <div class="RicecultivationwithSRI">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Agriculture E) Land Levelling</h6>
                                                        ...
                                                        <div class="form-group">
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                if ($cnt == 4) {
                                                                    ?>
                                                                    <tr id="hidedataA5">  
                                                                        <td style="width: 300px">Is done appointment of contractor?<input type="hidden" id="L5" name="L5" value="Is done appointment of contractor?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 5) {
                                                                    ?>
                                                                    <tr id="hidedataA6">  
                                                                        <td style="width: 300px">Is work completion report submitted and payment to contractor?<input type="hidden" id="L6" name="L6" value="Is work completion report submitted and payment to contractor?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA6">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. Area of land levelled (acres)</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="levelled_landarea" id="levelled_landarea" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
