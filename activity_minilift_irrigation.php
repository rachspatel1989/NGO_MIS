...
$db = new DB_Functions();
include_once './activity_minilift_irrigation_insert.php';
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="activity">
                                            ...
                                            <form action="#" method="post">
                                                <!-- Rice Cultivation -->
                                                <div class="MiniLiftIrrigationSchemes">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Water Resource Development O) Mini Lift Irrigation Schemes</h6>
                                                            ...
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if ($cnt == 0) {
                                                                        ?>
                                                                        <tr id="hidedataA1">  
                                                                            <td style="width: 300px">Is group formed as per eligibility criteria? <input type="hidden" id="L1" name="L1" value="Is group formed as per eligibility criteria? " class="form-control"></td>
                                                                ...
                                                                if ($cnt == 1) {
                                                                    ?>
                                                                    <tr id="hidedataA2">  
                                                                        <td style="width: 300px">Approval of concern authority of DBMGF for enterprise:<input type="hidden" id="L2" name="L2" value="Approval of concern authority of DBMGF for enterprise:" class="form-control"></td>
                                                                ...
                                                                if ($cnt == 2) {
                                                                    ?>
                                                                    <tr id="hidedataA3">  
                                                                        <td style="width: 300px">Is Legal documentation – Group agreement and common ownership of the assets of LIS done?<input type="hidden" id="L3" name="L3" value="Is Legal documentation – Group agreement and common ownership of the assets of LIS done?" class="form-control"></td>
                                                                        <td> 05 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA4">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. Microfinance amount for activity, If MF availed by Beneficiaries.</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4"></div>
                                                                        </div>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="microfinance_amount" id="quantity_seed" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4"></div>
                                                                        </div>
                                                                ...
                                                                if ($cnt == 4) {
                                                                    ?>
                                                                    <tr id="hidedataA5">  
                                                                        <td style="width: 300px">Is done purchase of Pumping machinery, pipes and accessories?<input type="hidden" id="L5" name="L5" value="Is done purchase of Pumping machinery, pipes and accessories?" class="form-control"></td>
                                                                        <td> 05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 5) {
                                                                    ?>
                                                                    <tr id="hidedataA6">  
                                                                        <td style="width: 300px">Is Proper installation of Pumping machinery, pipes and accessories and display board done?<input type="hidden" id="L6" name="L6" value="Is Proper installation of Pumping machinery, pipes and accessories and display board done?" class="form-control"></td>
                                                                        <td> 05 days </td>
                                                                        <td>
