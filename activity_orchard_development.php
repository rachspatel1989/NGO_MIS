...
$db = new DB_Functions();
include_once './activity_orchard_development_insert.php';
                                                ...
                                                <div class="RicecultivationwithSRI">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Agriculture F) Orchard Development</h6>
                                                            ...
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if ($cnt == 0) {
                                                                        ?>
                                                                        <tr id="hidedataA1">  
                                                                            <td style="width: 300px">Is cluster coordinator raised generated demand from eligible farmers for land levelling?<input type="hidden" id="L1" name="L1" value="Is cluster coordinator raised generated demand from eligible farmers for land levelling?" class="form-control"></td>
                                                                ...
                                                                if ($cnt == 4) {
                                                                    ?>
                                                                    <tr id="hidedataA5">  
                                                                        <td style="width: 300px">Is done Layout, pit digging and pit filling?<input type="hidden" id="L5" name="L5" value="Is done Layout, pit digging and pit filling?" class="form-control"></td>
                                                                        <td>08 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 5) {
                                                                    ?>
                                                                    <tr id="hidedataA6">  
                                                                        <td style="width: 300px">Is done support of orchard plants to farmer?<input type="hidden" id="L6" name="L6" value="Is done support of orchard plants to farmer?" class="form-control"></td>
                                                                        <td>10 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA6">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. No. of Plants</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>2. Name of Species</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="no_of_plant" id="no_of_plant" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                ...
                                                                if ($cnt == 6) {
                                                                    ?>
                                                                    <tr id="hidedataA7">  
                                                                        <td style="width: 300px">Is Fertilizer provided to the farmer and material receipt taken by him?<input type="hidden" id="L7" name="L7" value="Is Fertilizer provided to the farmer and material receipt taken by him?" class="form-control"></td>
                                                                        <td>10 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 7) {
                                                                    ?>
                                                                    <tr id="hidedataA8">  
                                                                        <td style="width: 300px">Is verified proper growth, fertilizer application and provision for irrigation?<input type="hidden" id="L8" name="L8" value="Is verified proper growth, fertilizer application and provision for irrigation?" class="form-control"></td>
                                                                        <td>15 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA8">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. No. of survival of Plants</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>2. Amount of DBMG Grant (INR)</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>3. LHWRF Grant (INR)</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="survival_no" id="survival_no" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>4. MF (INR)</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>5. Beneficiaries Contribution (INR)</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                ...
                                                                if ($cnt == 8) {
                                                                    ?>
                                                                    <tr id="hidedataA9">  
                                                                        <td style="width: 300px">Is equipment given to farmer?<input type="hidden" id="L9" name="L9" value="Is equipment given to farmer?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                    ...
                                                                    while ($activity_row = mysql_fetch_array($activity_sql)) {
                                                                        ...
                                                                        <tr id="hidedataA9">       
                                                                            ...
                                                                            <script type="text/javascript">
                                                                                $(function () {
                                                                                    $("#opendataA9").hide();
                                                                                    $("#btn-save").hide();
                                                                                    //document.getElementById(opendataA9).style.display = 'none'
                                                                                });
                                                                            </script>
                                                                            <?php
                                                                        } else {
                                                                        ...
                                                                        ?>
                                                                        <td>
                                                                            <input type="text" name="visit9" class="form-control" value="<?php echo $visit ?>" placeholder="" disabled>
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="remark9" class="form-control" value="<?php echo $remarks ?>" placeholder="">
                                                                        </td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                                                ...
                                                                ?>
                                                                <tr id="opendataA9" name="opendataA9">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>1. Name of equipment</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>2. Nos. of equipment</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="equipment_nos" id="equipment_nos" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </td>
