...
$db = new DB_Functions();
include_once './activity_poultry_insert.php';
                                                ...
                                                <div class="RicecultivationwithSRI">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Animal Husbandry H) Poultry</h6>
                                                        ...
                                                        <div class="form-group">
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                if ($cnt == 1) {
                                                                    ?>
                                                                    <tr id="hidedataA2">  
                                                                        <td style="width: 300px">Is poultry management training given to farmers?<input type="hidden" id="L2" name="L2" value="Is poultry management training given to farmers?" class="form-control"></td>
                                                                ...
                                                                if ($cnt == 2) {
                                                                    ?>
                                                                    <tr id="hidedataA3">  
                                                                        <td style="width: 300px">Is Construction of poultry shed done by the beneficiary as his/her contribution for the activity?<input type="hidden" id="L3" name="L3" value="Is Construction of poultry shed done by the beneficiary as his/her contribution for the activity?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 3) {
                                                                    ?>
                                                                    <tr id="hidedataA4">  
                                                                        <td style="width: 300px">Expected contribution for poultry feed & medicine from the beneficiary is received, receipt issued to the farmer and deposited to DBMGF account.<input type="hidden" id="L4" name="L4" value="Expected contribution for poultry feed & medicine from the beneficiary is received, receipt issued to the farmer and deposited to DBMGF account." class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 4) {
                                                                    ?>
                                                                    <tr id="hidedataA5">  
                                                                        <td style="width: 300px">Is done Support of Feeder & Waterer pots?<input type="hidden" id="L5" name="L5" value="Is done Support of Feeder & Waterer pots?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 5) {
                                                                    ?>
                                                                    <tr id="hidedataA6">  
                                                                        <td style="width: 300px">Is done support of poultry chicks to the beneficiary?<input type="hidden" id="L6" name="L6" value="Is done support of poultry chicks to the beneficiary?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA6">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. Nos. of Poultry Chicks supported</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>2. Variety of poultry chicks.</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>3. Cost of DBMG Grant (INR)</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="poultry_chicks" id="poultry_chicks" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="poultry_chicks_variety" id="poultry_chicks_variety" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>4. Contribution of Farmers (INR)</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>5. Micro-Finance (INR)</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>6. NABARD</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="farmers_contribution" id="farmers_contribution" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                ...
                                                                if ($cnt == 6) {
                                                                    ?>
                                                                    <tr id="hidedataA7">  
                                                                        <td style="width: 300px">Is Verification done for Vaccination and recommended feed dose given to the chicks?<input type="hidden" id="L7" name="L7" value="Is Verification done for Vaccination and recommended feed dose given to the chicks?" class="form-control"></td>
                                                                        <td>05 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA7">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. Nos. of Poultry chicks survival</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4"></div>
                                                                        </div>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="survived_chicks" id="survived_chicks" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4"></div>
                                                                        </div>
