...
$db = new DB_Functions();
include_once './activity_rice_cultivation_insert.php';
                                                ...
                                                <div class="RicecultivationwithSRI">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Agriculture A) Rice cultivation with SRI</h6>
                                                            ...
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if ($cnt == 0) {
                                                                        ?>
                                                                        <tr id="hidedataA1">  
                                                                            <td style="width: 300px">Is SRI training given to the farmer/beneficiary?<input type="hidden" id="L1" name="L1" value="Is SRI training given to the farmer/beneficiary?" class="form-control"></td>
                                                                ...
                                                                if ($cnt == 1) {
                                                                    ?>
                                                                    <tr id="hidedataA2">  
                                                                        <td style="width: 300px">Expected contribution money from the farmer is received and receipt issued to the farmer/ beneficiary<input type="hidden" id="L2" name="L2" value="Expected contribution money from the farmer is received and receipt issued to the farmer/ beneficiary" class="form-control"></td>
                                                                ...
                                                                if ($cnt == 2) {
                                                                    ?>
                                                                    <tr id="hidedataA3">  
                                                                        <td style="width: 300px">Seed and fertilizer support provided to the farmer and farmers receipt about the material received was taken<input type="hidden" id="L3" name="L3" value="Seed and fertilizer support provided to the farmer and farmers receipt about the material received was taken" class="form-control"></td>
                                                                        <td>+ 8 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 4) {
                                                                    ?>
                                                                    <tr id="hidedataA5">  
                                                                        <td style="width: 300px">Sowing was done as per SRI technique<input type="hidden" id="L5" name="L5" value="Sowing was done as per SRI technique" class="form-control"></td>
                                                                        <td>+ 15 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 5) {
                                                                    ?>
                                                                    <tr id="hidedataA6">  
                                                                        <td style="width: 300px">Proper germination and fertilizer application<input type="hidden" id="L6" name="L6" value="Proper germination and fertilizer application" class="form-control"></td>
                                                                        <td>+ 15 days </td>
                                                                        <td>
