...
$db = new DB_Functions();
include_once './activity_skilltraining_insert.php';
                                                ...
                                                <div class="SkillTraining">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Non-Farm Sector: J) Skill Training </h6>
                                                            ...
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if ($cnt == 0) {
                                                                        ?>
                                                                        <tr id="hidedataA1">  
                                                                            <td style="width: 300px">The beneficiary got the approval of concern authority of DBMGF for trade:<input type="hidden" id="L1" name="L1" value="The beneficiary got the approval of concern authority of DBMGF for trade:" class="form-control"></td>

                                                                            <td> NA </td>
                                                                            <td>
                                                                                <div class="row">
                                                                                    <div class="form-group">
                                                                                        <input type="text" name="trade_name" id="trade_name" class="form-control" placeholder="Name of trade">
                                                                                    </div>
                                                                                </div><br/>
                                                                                <div class="row">
                                                                                    <div class="form-group">
                                                                                        <input type="text" name="training_duration" id="training_duration" class="form-control" placeholder="Duration of training">
                                                                                    </div>
                                                                                </div><br/>
                                                                                <div class="row">
                                                                                    <div class="form-group">
                                                                                        <input type="text" name="training_venue" id="training_venue" class="form-control" placeholder="Agency & Venue of training">
                                                                                    </div>
                                                                                </div><br/>
                                                                        ...
                                                                        while ($activity_row = mysql_fetch_array($activity_sql)) {
                                                                            ...
                                                                            <tr id="hidedataA1">       
                                                                                ...
                                                                                <td> NA </td>
                                                                                <td>
                                                                                    <input type="text" name="trade_name" class="form-control" value="<?php echo $remarks ?>" placeholder=""><br/>
                                                                                    <input type="text" name="training_duration" class="form-control" value="<?php echo $remarks ?>" placeholder=""><br/>
                                                                                    <input type="text" name="training_venue" class="form-control" value="<?php echo $remarks ?>" placeholder=""><br/>

                                                                                    <?php
                                                                                    if ($action == "Completed") {
                                                                                        echo "<input name='A1' type='radio' id='completedYesA1' checked='checked' value='Completed'> Completed </td>";
                                                                                        ?>
                                                                                        <script type="text/javascript">
                                                                                            $(function () {
                                                                                                $("#hidedataA2").show();
                                                                    ...
                                                                    if ($cnt == 1) {
                                                                        ?>
                                                                        <tr id="hidedataA2">  
                                                                            <td style="width: 300px">Expected contribution money from the beneficiary is received, receipt issued to the beneficiary  <input type="hidden" id="L2" name="L2" value="Expected contribution money from the beneficiary is received, receipt issued to the beneficiary  " class="form-control"></td>
                                                                ...
                                                                if ($cnt == 2) {
                                                                    ?>
                                                                    <tr id="hidedataA3">  
                                                                        <td style="width: 300px">Is training given to the beneficiary?<input type="hidden" id="L3" name="L3" value="Is training given to the beneficiary?" class="form-control"></td>
                                                                        <td> 30 to 60 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 3) {
                                                                    ?>
                                                                    <tr id="hidedataA4">  
                                                                        <td style="width: 300px">Is beneficiary  participated in exam and successful completion of training to test basic practical knowledge?<input type="hidden" id="L4" name="L4" value="Is beneficiary  participated in exam and successful completion of training to test basic practical knowledge?" class="form-control"></td>
                                                                        <td> 75 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 4) {
                                                                    ?>
                                                                    <tr id="hidedataA5">  
                                                                        <td style="width: 300px">Have you prepared action plan of the beneficiary as per his/her interest and organizations guideline?<input type="hidden" id="L5" name="L5" value="Have you prepared action plan of the beneficiary as per his/her interest and organizations guideline?" class="form-control"></td>
                                                                        <td> 80 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 5) {
                                                                    ?>
                                                                    <tr id="hidedataA6">  
                                                                        <td style="width: 300px">Which option beneficiary has selected?<input type="hidden" id="L6" name="L6" value="Which option beneficiary has selected?" class="form-control"></td>
                                                                        <td> 85 days </td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <div class="multi-select-full">
                                                                                    <select class="multiselect" name="employee[]" multiple="multiple">
                                                                                        <option value="Wage employment">Wage employment</option>
                                                                                        <option value="Grant support for self-employment">Grant support for self-employment</option>
                                                                                        <option value="Credit support for self-employment">Credit support for self-employment</option>
                                                                                        <option value="Not suitable or not interested for any employment">Not suitable or not interested for any employment</option>
                                                                                    </select>
                                                                                </div>
                                                                            </div><br/>
                                                                    ...
                                                                    while ($activity_row = mysql_fetch_array($activity_sql)) {
                                                                        ...
                                                                        <tr id="hidedataA6">       
                                                                            ...
                                                                            <td> 85 days </td>
                                                                            <td>
                                                                                <input type="text" name="employee" class="form-control" value="<?php echo $remarks ?>" placeholder="">

                                                                                <?php
                                                                                if ($action == "Completed") {
                                                                                    echo "<input name='A6' type='radio' id='completedYesA6' checked='checked' value='Completed'> Completed </td>";
                                                                                    ?>
                                                                                    <script type="text/javascript">
                                                                                        $(function () {
                                                                                            $("#hidedataA7").show();
