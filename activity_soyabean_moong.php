...
$db = new DB_Functions();
include_once './activity_soyabean_moong_insert.php';
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="activity">
                                            ...
                                            <form action="#" method="post">
                                                <!-- Soyabean/Moong Cultivation -->
                                                <div class="SoyabeanMoongCultivation">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Agriculture B) Soyabean/Moong Cultivation:</h6>
                                                            ...
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if ($cnt == 0) {
                                                                        ?>
                                                                        <tr id="hidedataA1">  
                                                                            <td style="width: 300px">The beneficiary got the approval of concern authority of DBMGF for intervention.<input type="hidden" id="L1" name="L1" value="The beneficiary got the approval of concern authority of DBMGF for intervention." class="form-control"></td>
                                                                        ...
                                                                        while ($activity_row = mysql_fetch_array($activity_sql)) {
                                                                            ...
                                                                            echo "<td><input name='A1' type='radio' id='pendingYesA1' value='Pending'> Pending <br/><input name='A1' type='radio' id='completedYesA1' value='Completed'> Completed <br/><input name='A1' type='radio' id='terminatedYesA1' value='Terminate'> Terminate </td>";
                                                                        }
                                                                        ?>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA1">  
                                                                    <td colspan="5">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <select name="soyabean_moong" id="soyabean_moong" class="form-control">
                                                                                    <option value="null">select</option>
                                                                                    <option value="Soyabean Cultivation">Soyabean Cultivation</option>
                                                                                    <option value="Moong Cultivation">Moong Cultivation</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4"></div>
                                                                ...
                                                                if ($cnt == 1) {
                                                                    ?>
                                                                    <tr id="hidedataA2">  
                                                                        <td style="width: 300px">Is Soyabean / Moong cultivation training given to the farmer/ beneficiary?<input type="hidden" id="L2" name="L2" value="Is Soyabean / Moong cultivation training given to the farmer/ beneficiary?" class="form-control"></td>
                                                                ...
                                                                if ($cnt == 2) {
                                                                    ?>
                                                                    <tr id="hidedataA3">  
                                                                        <td style="width: 300px">Expected contribution money from the farmer is received and receipt issued to the farmer/ beneficiary.<input type="hidden" id="L3" name="L3" value="Expected contribution money from the farmer is received and receipt issued to the farmer/ beneficiary." class="form-control"></td>
                                                                        <td>+ 10 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 3) {
                                                                    ?>
                                                                    <tr id="hidedataA4">  
                                                                        <td style="width: 300px">Seed support provided to the farmer/ beneficiary and farmers receipt about the material received is taken<input type="hidden" id="L4" name="L4" value="Seed support provided to the farmer/ beneficiary and farmers receipt about the material received is taken" class="form-control"></td>
                                                                        <td>+ 8 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA4">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. Quantity of Seed</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>2. Name variety of Seed</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>3. Total cost of Seed (INR)</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="quantity_seed" id="quantity_seed" class="form-control" placeholder="Quantity of Seed">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="variety_seed" id="variety_seed" class="form-control" placeholder="Name variety of Seed">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="cost_seed" id="cost_seed" class="form-control" placeholder="Total cost of Seed (INR)">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                if ($cnt == 4) {
                                                                    ?>
                                                                    <tr id="hidedataA5">  
                                                                        <td style="width: 300px">Fertilizer support provided to the farmer/ beneficiary and farmers receipt about the material received is taken<input type="hidden" id="L5" name="L5" value="Fertilizer support provided to the farmer/ beneficiary and farmers receipt about the material received is taken" class="form-control"></td>
                                                                        <td>+ 9 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA5">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. Name of Fertilizer</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>2. Quantity of Fertilizer</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>3. Total cost of Fertilizer (INR)</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="name_fertilizer" id="name_fertilizer" class="form-control" placeholder="Name of Fertilizer">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="quantity_fertilizer" id="quantity_fertilizer" class="form-control" placeholder="Quantity of Fertilizer">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="cost_fertilizer" id="cost_fertilizer" class="form-control" placeholder="Total cost of Fertilizer (INR)">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                if ($cnt == 5) {
                                                                    ?>
                                                                    <tr id="hidedataA6">  
                                                                        <td style="width: 300px">Sowing was done as per training<input type="hidden" id="L6" name="L6" value="Sowing was done as per training" class="form-control"></td>
                                                                        <td>+ 15 days </td>
                                                                        <td>
                                                                ...
                                                                <tr id="opendataA6">  
                                                                    <td colspan="5">
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label>1. Amount of DBMG Grant (INR)</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="amount_grant" id="amount_grant" class="form-control" placeholder="Amount of DBMG Grant (INR)">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="lhwrf_grant" id="lhwrf_grant" class="form-control" placeholder="LHWRF Grant (INR)">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="mf" id="mf" class="form-control" placeholder="MF (INR)">
                                                                                </div>
                                                                            </div>
                                                                        </div><br/>
                                                                        <div class="row">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="benifi_contribution" id="benifi_contribution" class="form-control" placeholder="Beneficiaries Contribution (INR)">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="nabard" id="nabard" class="form-control" placeholder="NABARD">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="othersB6" id="othersB6" class="form-control" placeholder="Others">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                if ($cnt == 6) {
                                                                    ?>
                                                                    <tr id="hidedataA7">  
                                                                        <td style="width: 300px">Proper germination and fertilizer application<input type="hidden" id="L7" name="L7" value="Proper germination and fertilizer application" class="form-control"></td>
                                                                        <td>+ 15 days </td>
                                                                        <td>
                                                                ...
                                                                if ($cnt == 7) {
                                                                    ?>
                                                                    <tr id="hidedataA8">  
                                                                        <td style="width: 300px">Start the end-line survey<input type="hidden" id="L8" name="L8" value="Start the end-line survey" class="form-control"></td>
                                                                        <td>+ 45 days </td>
                                                                        <td>
