...
$db = new DB_Functions();
include_once './activity_vegetable_cultivation_insert.php';
                                                ...
                                                <div class="RicecultivationwithSRI">
                                                    <div class="panel panel-white">
                                                        <div class="panel-heading">
                                                            <h6 class="panel-title text-semibold">Agriculture D) Vegetable cultivation</h6>
                                                            ...
                                                            <table class="table table-striped media-library table-lg">
                                                                ...
                                                                <tr id="opendataA1">  
                                                                    <td colspan="5">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <select name="vegetable" id="vegetable" class="form-control">
                                                                                    <option value="null">select</option>
                                                                                    <option value="Chilli Cultivation">Chilli Cultivation</option>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <input type="text" name="other_vegetable" class="form-control" placeholder="Specify if any">
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                if ($cnt == 1) {
                                                                    ?>
                                                                    <tr id="hidedataA2">  
                                                                        <td style="width: 300px">Is vegetable cultivation training given to the farmer/ beneficiary?<input type="hidden" id="L2" name="L2" value="Is vegetable cultivation training given to the farmer/ beneficiary?" class="form-control"></td>
                                                                ...
                                                                <tr id="opendataA4">  
                                                                    <td colspan="5">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="quantity_seed" id="quantity_seed" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="variety_seed" id="variety_seed" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="cost_seed" id="cost_seed" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr id="opendataA5">  
                                                                    <td colspan="5">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="name_fertilizer" id="name_fertilizer" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="quantity_fertilizer" id="quantity_fertilizer" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="cost_fertilizer" id="cost_fertilizer" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </td>
