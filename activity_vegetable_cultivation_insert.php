...
// receiving the post params
    ...
    if ($cnt == 0) {
        ...
        $reg_via = "Web";
        $activity_name = $_POST['vegetable'];
        $other_activity = $_POST['other_vegetable'];
        ...
        $query1 = mysql_query("INSERT INTO activity_progress_details_master(login_id,beneficiary_id,activity_name,other_activity,reg_via,reg_device_id,reg_created_date,reg_timestamp) VALUES('$login_id','$benificiary_id','$activity_name','$other_activity','$reg_via','$ip',STR_TO_DATE('$date','%m/%d/%Y%h:%i'),'$timestamp')");
