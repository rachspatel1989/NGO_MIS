<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            $(function () {
                $("input[name='source_usability[]']").click(function () {
        ...
        <script type="text/javascript">
            $(function () {
                $("input[name='issource_own_lease[]']").click(function () {
                        ...
                        <div class="form-group">
                            <div class="radio">
                                <label class="radio-inline">
                                    <input type="radio" name="source_usability[]" id="communityNo" value="No">
                                    No
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="source_usability[]" id="communityYes" value="Yes">
                                    Yes
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="row" id="Q12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="radio">
                                    <label class="radio-inline">
                                        <input name="issource_own_lease[]" id="useirrigationNo" type="radio" value="No">
                                        No 
                                    </label>
                                    <label class="radio-inline">
                                        <input name="issource_own_lease[]" id="useirrigationYes" type="radio" value="Yes">
                                        Yes
                                    </label>
                                </div>
                            </div>
                    ...
                    <div id="useirrigationhide">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="checkbox-inline" for="havesource_type_own">
                                        <input name="havesource_type[]" id="havesource_type_own" type="checkbox" value="Own">
                                        <b>Own</b>
                                    </label>
                                    <label class="checkbox-inline" for="havesource_type_lease">
                                        <input name="havesource_type[]" id="havesource_type_lease" type="checkbox" value="Lease">
                                        <b>Lease</b>
                                    </label>
                                    <label class="checkbox-inline" for="havesource_type_useingroup">
                                        <input name="havesource_type[]" id="havesource_type_useingroup" type="checkbox" value="Use in group of farmers">
                        ...
                        <div id="havesource_type_ownhide">
                            <div class="row" id="Q14">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="own_source[]" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" id="Q151">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select name="select" class="form-control" name="iswater_own_kharif[]">
                                            <option value="null">Select</option>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>b. Rabi</label>
                                        <select name="select" class="form-control" name="iswater_own_rabi[]">
                                            <option value="null">Select</option>
                                            <option value="Adequate">Adequate</option>
                                            <option value="Somewhat adequate">Somewhat adequate</option>
                                            <option value="Not adequate">Not adequate</option>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select name="select" class="form-control" name="iswater_own_summer[]">
                                            <option value="null">Select</option>
                                            <option value="Adequate">Adequate</option>
                                            <option value="Somewhat adequate">Somewhat adequate</option>
                                            <option value="Not adequate">Not adequate</option>
                        ...
                        <div id="havesource_type_leasehide">
                            <div class="row" id="Q16">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="lease_source[]" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" id="Q171">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>a. Kharif</label>
                                        <select name="select" class="form-control" name="iswater_lease_kharif[]">
                                            <option value="null">Select</option>
                                            <option value="Adequate">Adequate</option>
                                            <option value="Somewhat adequate">Somewhat adequate</option>
                                            <option value="Not adequate">Not adequate</option>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>b. Rabi</label>
                                        <select name="select" class="form-control" name="iswater_lease_rabi[]">
                                            <option value="null">Select</option>
                                            <option value="Adequate">Adequate</option>
                                            <option value="Somewhat adequate">Somewhat adequate</option>
                                            <option value="Not adequate">Not adequate</option>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>c. Summer</label>
                                        <select name="select" class="form-control" name="iswater_lease_summer[]">
                                            <option value="null">Select</option>
                                            <option value="Adequate">Adequate</option>
                                            <option value="Somewhat adequate">Somewhat adequate</option>
                                            <option value="Not adequate">Not adequate</option>
                        ...
                        <div id="havesource_type_useingrouphide">
                            <div class="row" id="Q18">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="group_source[]" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" id="Q191">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>a. Kharif</label>
                                        <select name="select" class="form-control" name="iswater_group_kharif[]">
                                            <option value="null">Select</option>
                                            <option value="Adequate">Adequate</option>
                                            <option value="Somewhat adequate">Somewhat adequate</option>
                                            <option value="Not adequate">Not adequate</option>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>b. Rabi</label>
                                        <select name="select" class="form-control" name="iswater_group_rabi[]">
                                            <option value="null">Select</option>
                                            <option value="Adequate">Adequate</option>
                                            <option value="Somewhat adequate">Somewhat adequate</option>
                                            <option value="Not adequate">Not adequate</option>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>c. Summer</label>
                                        <select name="select" class="form-control" name="iswater_group_summer[]">
                                            <option value="null">Select</option>
                                            <option value="Adequate">Adequate</option>
                                            <option value="Somewhat adequate">Somewhat adequate</option>
                                            <option value="Not adequate">Not adequate</option>
