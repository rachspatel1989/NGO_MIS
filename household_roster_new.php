...
include_once 'householdroster_insert.php';
                                        ...
                                        <div class="col-md-12">
                                            <fieldset class="text-semibold">
                                                <div class="row">
                                                    <div class="content-group">                                                        
                                                                ...
                                                                if ($cnt == 0) {
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <input type="text" class="form-control" id="noofmembers" name="noofmembers" placeholder="Number of members (1-20)" required>
                                                                            </div>
                                                                        </div>
                                                                    </div><br/><?php
                                                                } else {
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control" name="fm_member_name" placeholder="Name of Person" required>
                                                                </div>
                                                            </div>
                                                        </div><br/>
                                                        <div class="row">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <label class="radio-inline" for="fm_gender">
                                                                        <input type="radio" name="fm_gender" id="male" value="Male">
                                                                        Male
                                                                    </label>
                                                                    <label class="radio-inline" for="fm_gender">
                                                                        <input type="radio" name="fm_gender" id="female" value="Female">
                                                                        Female
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control" name="fm_age" id="field1" placeholder="For children under 1 year, report 0 for age" required>
                                                                </div>
                                                            </div>
                                                        </div><br/>
                                                        <div class="row">
                                                        ...
                                                        <div class="row" id="hideeduction">
                                                            <div class="form-group" id="greaterthan61">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control" name="fm_education" id="education" placeholder="Education">
                                                                </div>
                                                            </div>
                                                        </div><br/>
                                                        <div class="row">
                                                        ...
                                                        <div class="row" id="table2">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control" name="fm_emp_name" placeholder="Name of Person">
                                                                </div>
                                                            </div><br/><br/>
                                                            <div class="form-group">
                                                                <label class="control-label col-lg-6">B12. What is the per month salary of <b>[**PERSON**]?</b></label>
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control" name="fm_per_month_salary" placeholder="Rupees">
                                                                </div>
                                                            </div>
                                                        </div><br/>
                                                    </div>
                                                    <br/>
                                                    <?php
                                                    $sql = "SELECT MAX(family_id) as family_id FROM family_master";
                                                    $selectResp = mysql_query($sql);
                                                    while ($rows = mysql_fetch_assoc($selectResp)) {
                                                        $family_id = $rows['family_id'];
                                                        $sql = mysql_query("SELECT Count(family_member_master.fm_id) as cnt FROM family_member_master WHERE family_member_master.family_id = $family_id");
                                                        $row = mysql_fetch_array($sql);
                                                        ...
                                                        if (($cnt + 1) == $memberno) {
                                                            ...
                                                            <div class="text-right">
                                                                <button type="submit" class="btn btn-primary" name="btn-save" value="save">Submit & Next <i class="icon-arrow-right14 position-right"></i></button>
                                                            </div><br/>
                                                            <?php
                                                        } else {
                                                            ?>
