...
if (isset($_POST['btn-save'])) {
    ...
    $sql_update = mysql_query("Update family_master set activity_status= '0', reg_modified_date= STR_TO_DATE('$date', '%m/%d/%Y%h:%i'), reg_timestamp= '$timestamp' WHERE family_id = '$family_id'");
    ?>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content">
                        ...
                        <div class="panel panel-flat">
                            ...
                            $selectSQL = 'SELECT family_master.family_phone,village_master.village_name,family_member_master.fm_occupation_id,family_member_master.fm_per_month_salary,family_master.family_id,family_member_master.fm_member_name FROM family_master INNER JOIN family_member_master ON family_master.family_id = family_member_master.family_id INNER JOIN village_master ON family_master.village_id = village_master.village_id WHERE family_member_master.fm_status = 1 AND family_master.activity_status = 1';
