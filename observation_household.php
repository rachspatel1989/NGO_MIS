                                            ...
                                            <fieldset class="text-semibold">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="roomno" class="form-control" placeholder="Total number of rooms" onkeyup="this.value = fnc(this.value, 1, 25)">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="content-group-lg">
                                                            <label class="radio-inline">
                                                                <input name="kitchenlocated" type="radio" value="Inside the house with no partition">
                                                                Inside the house with no partition
                                                            </label><br/>
                                                            <label class="radio-inline">
                                                                <input name="kitchenlocated" type="radio" value="Inside the house with partition">
                                                                Inside the house with partition
                                                            </label><br/>
                                                            <label class="radio-inline">
                                                                <input name="kitchenlocated" type="radio" value="Inside the house with separate room">
                                                                Inside the house with separate room
                                                            </label><br/>
                                                            <label class="radio-inline">
                                                                <input name="kitchenlocated" type="radio" value="Attached room outside the house with separate entrance">
                                                                Attached room outside the house with separate entrance
                                                            </label><br/>
                                                            <label class="radio-inline">
                                                                <input name="kitchenlocated" type="radio" value="Outside the house in a standalone room">
                                                                Outside the house in a standalone room
                                                            </label><br/>
                                                            <label class="radio-inline">
                                                                <input name="kitchenlocated" type="radio" value="Outside the house; open air">
                                                            ...
                                                            <label class="radio-inline">
                                                                <input type="text" name="backsupportcheckingname" class="form-control" placeholder="Specify">
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="content-group-lg">
                                                            <label class="radio-inline">
                                                                <input name="stovetype" type="radio" value="Open fire / Rudimentary 3 stones">
                                                                Open fire / Rudimentary 3 stones
                                                            </label><br/>
                                                            <label class="radio-inline">
                                                                <input name="stovetype" type="radio" value="Chulha">
                                                                Chulha
                                                            </label><br/>
                                                            <label class="radio-inline">
                                                                <input name="stovetype" type="radio" value="Kerosene burner">
                                                                Kerosene burner 
                                                            </label><br/>
                                                            <label class="radio-inline">
                                                                <input name="stovetype" type="radio" value="Gas burner">
                                                                Gas burner
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="content-group-lg">
                                                            <label class="radio-inline">
                                                                <input name="havetoilet" type="radio" value="Yes">
                                                                Yes
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input name="havetoilet" type="radio" value="No">
                                                                No
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="content-group-lg">
                                                            <label class="radio-inline">
                                                                <input name="havepipedwater" type="radio" value="No">
                                                                No
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input name="havepipedwater" type="radio" value="Yes">
                                                                Yes
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="content-group-lg">
                                                            <label class="radio-inline">
                                                                <input name="haveelectricity" type="radio" value="No">
                                                                No
                                                            </label><br/>
                                                            <label class="radio-inline">
                                                                <input name="haveelectricity" type="radio" value="Yes, but not in working condition">
                                                                Yes, but not in working condition
                                                            </label><br/>
                                                            <label class="radio-inline">
                                                                <input name="haveelectricity" type="radio" value="Yes, working">
                                                                Yes, working 
                                                            </label><br/>
                                                            <label class="radio-inline">
                                                                <input name="haveelectricity" type="radio" value="HH has un-official electric connection">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="content-group-lg">
                                                            <label class="radio-inline">
                                                                <input name="haveland" type="radio" value="No">
                                                                No
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input name="haveland" type="radio" value="Yes">
                                                                Yes
                                                            </label>
                                                        </div>
                                                    </div>
