...
include_once 'personaldata_insert.php';
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="family_habitation" id="family_habitation" class="form-control" placeholder="Habitation Name" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="family_phone" id="family_phone" class="form-control" maxlength="10" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" required />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="family_head_name" id="family_head_name" class="form-control" placeholder="HH Head Name" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="family_address" id="family_address" rows="4" cols="4" placeholder="Address of HH" class="form-control" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
