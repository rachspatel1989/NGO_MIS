        ...
        <div class="page-container" style="min-height:933px">
            ...
            <div class="page-content">
                ...
                <div class="content-wrapper">
                    ...
                    $select_fami_sql = mysql_query("SELECT * FROM family_selfemp_master where family_id='$get_family_id'");
                    $row_fam = mysql_fetch_array($select_fami_sql);
                    $familymember = implode(', ', $_POST['se_family_member']);
                    $trainingrequired = $row_fam['se_training_required'];
                    $grantreceive = implode(', ', $row_fam['se_grant_received']);
                    $investmentgrant = $row_fam['se_investment_for_grant'];
                    $investmentcredit = $row_fam['se_investment_for_credit'];
                    ?>
                    <!-- /page header -->
                    <!-- Content area -->
                    <div class="content">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-group">
                                                                <label class="checkbox-inline" for="familymemberNo">
                                                                    <input name="familymember[]" id="familymemberNo" type="checkbox" <?php if (isset($familymember) && $familymember == "No") echo "checked"; ?> value="No">
                                                                    No
                                                                </label>
                                                                <label class="checkbox-inline" for="familymemberskilled">
                                                                    <input name="familymember[]" id="familymemberskilled" type="checkbox" <?php if (isset($familymember) && $familymember == "Skilled artisan") echo "checked"; ?> value="Skilled artisan">
                                                                    Skilled artisan
                                                                </label>
                                                                <label class="checkbox-inline" for="familymemberself">
                                                                    <input name="familymember[]" id="familymemberself" type="checkbox" <?php if (isset($familymember) && $familymember == "Self-employed business / shop") echo "checked"; ?> value="Self-employed business / shop">
                                                ...
                                                <div id="hidedata">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="content-group-lg">
                                                                <label class="radio-inline">
                                                                    <input name="trainingrequired" id="trainingrequiredNoEnoughTraining" type="radio" <?php if (isset($trainingrequired) && $trainingrequired == "No: We had enough training/ knowledge") echo "checked"; ?> value="No: We had enough training/ knowledge">
                                                                    No: We had enough training/ knowledge
                                                                </label><br/>
                                                                <label class="radio-inline">
                                                                    <input name="trainingrequired" id="trainingrequiredNoNeedTeaining" type="radio" <?php if (isset($trainingrequired) && $trainingrequired == "No: We do not need the training") echo "checked"; ?> value="No: We do not need the training">
                                                                    No: We do not need the training
                                                                </label><br/>
                                                                <label class="radio-inline">
                                                                    <input name="trainingrequired" id="trainingrequiredYes" type="radio" <?php if (isset($trainingrequired) && $trainingrequired == "Yes") echo "checked"; ?> value="Yes">
                                                                    Yes
                                                                </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="checkbox-inline" for="grantreceiveNo">
                                                                    <input name="grantreceive[]" id="grantreceiveNo" type="checkbox" <?php if (isset($grantreceive) && $grantreceive == "No") echo "checked"; ?> value="No">
                                                                    No
                                                                </label>
                                                                <label class="checkbox-inline" for="grantreceiveGovernment">
                                                                    <input name="grantreceive[]" id="grantreceiveGovernment" type="checkbox" <?php if (isset($grantreceive) && $grantreceive == "Government") echo "checked"; ?> value="Government">
                                                                    Government
                                                                </label>
                                                                <label class="checkbox-inline" for="grantreceiveDBMGF">
                                                                    <input name="grantreceive[]" id="grantreceiveDBMGF" type="checkbox" <?php if (isset($grantreceive) && $grantreceive == "DBMGF") echo "checked"; ?> value="DBMGF">
                                                                    DBMGF
                                                                </label>
                                                                <label class="checkbox-inline" for="grantreceiveNGO">
                                                                    <input name="grantreceive[]" id="grantreceiveNGO" type="checkbox" <?php if (isset($grantreceive) && $grantreceive == "NGO other than DBMGF") echo "checked"; ?> value="NGO other than DBMGF">
                                                                    NGO other than DBMGF
                                                                </label>
                                                                <label class="checkbox-inline" for="grantreceiveMGF">
                                                                    <input name="grantreceive[]" id="grantreceiveMGF" type="checkbox" <?php if (isset($grantreceive) && $grantreceive == "MFG, Bank, money lander") echo "checked"; ?> value="MFG, Bank, money lander">
                                                                    MFG, Bank, money lander
                                                                </label><br/>
                                                                <label class="checkbox-inline" for="grantreceiveDonot">
                                                                    <input name="grantreceive[]" id="grantreceiveDonot" type="checkbox" <?php if (isset($grantreceive) && $grantreceive == "Don’t know") echo "checked"; ?> value="Don’t know">
                                                                    Don’t know
                                                                </label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="hidedata1">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input type="text" name="investmentgrant" id="investmentgrant" value="<?php echo $investmentgrant; ?>" class="form-control" placeholder="Rupees">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input type="text" name="investmentcredit" id="investmentcredit" value="<?php echo $investmentcredit; ?>" class="form-control" placeholder="Rupees">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
