...
include_once 'socioeconomics_update.php';
        ...
        <div class="page-container" style="min-height:933px">
            ...
            <div class="page-content">
                ...
                <div class="content-wrapper">
                    ...
                    $select_household_sql = mysql_query("SELECT * FROM family_household_master where family_id='$get_family_id'");
                    $select_foodconsumption_sql = mysql_query("SELECT * FROM family_foodconsumption_master where family_id='$get_family_id'");
                    $select_migration_sql = mysql_query("SELECT * FROM family_migration_master where family_id='$get_family_id'");
                    $select_nonfoodexp_sql = mysql_query("SELECT * FROM family_nonfoodexp_master where family_id='$get_family_id'");                    
                    $select_asset_sql = mysql_query("SELECT * FROM family_asset_master where family_id='$get_family_id'");
                    $select_savings_sql = mysql_query("SELECT * FROM family_savings_master where family_id='$get_family_id'");

                    $row_household = mysql_fetch_array($select_household_sql);
                    $row_foodconsumption = mysql_fetch_array($select_foodconsumption_sql);
                    $row_migration = mysql_fetch_array($select_migration_sql);
                    $row_nonfoodexp = mysql_fetch_array($select_nonfoodexp_sql);                    
                    $row_asset = mysql_fetch_array($select_asset_sql);
                    $row_savings = mysql_fetch_array($select_savings_sql);

                    $caste = isset($row_household['hh_caste_category']);
                    $povertyline = isset($row_household['hh_family_type']);
                    $availability = $row_household['hh_family_house'];
                    $housevalue = $row_household['hh_market_value'];
                    $monthrent = $row_household['hh_market_rent'];

                    $buyfood = $row_foodconsumption['fd_consumed_per_month'];
                    $consumefood = $row_foodconsumption['fd_grown_consumption'];
                    $quantityoffood = $row_foodconsumption['fd_cost_per_month'];
                    $receivedwages = $row_foodconsumption['fd_wages_consumption'];
                    $costfood = $row_foodconsumption['fd_wages_cost'];
                    $rainfall = $row_foodconsumption['fd_type_of_rainfall'];

                    $migrated = $row_migration['mg_for_work'];
                    $migrating = $row_migration['mg_reason'];
                    $totalmembers = $row_migration['mg_no_of_members'];
                    $totaltime = $row_migration['mg_no_of_times'];
                    $totaldays = $row_migration['mg_total_days_worked'];
                    $reducedtrips = $row_migration['mg_total_trips'];
                    $reduceddays = $row_migration['mg_total_days'];

                    $cost_per_year = $row_nonfoodexp['cost_per_year'];
                    $expense_id = $row_nonfoodexp['expense_id'];

                    $select_income_sql = mysql_query("SELECT * FROM family_income_master where family_id='$get_family_id'");
                    $row_income = mysql_fetch_array($select_income_sql);
                    $income_textbox1 = $row_income['hhd_earnings_per_year'];
                    $income1 = $row_income['hhd_income_recieved'];
                    
//                    $income_textbox2 = $row_income['hhd_earnings_per_year'];
//                    $income_textbox3 = $row_income['hhd_earnings_per_year'];
//                    $income_textbox4 = $row_income['hhd_earnings_per_year'];
//                    $income_textbox5 = $row_income['hhd_earnings_per_year'];
//                    $income_textbox6 = $row_income['hhd_earnings_per_year'];
//                    $income_textbox7 = $row_income['hhd_earnings_per_year'];
//                    $income_textbox8 = $row_income['hhd_earnings_per_year'];
//                    $income_textbox9 = $row_income['hhd_earnings_per_year'];
//                    $income_textbox10 = $row_income['hhd_earnings_per_year'];
//                    $income_textbox11 = $row_income['hhd_earnings_per_year'];
//                    $income_textbox12 = $row_income['hhd_earnings_per_year'];
//                    $income_textbox13 = $row_income['hhd_earnings_per_year'];
//                    $income_textbox14 = $row_income['hhd_earnings_per_year'];

                    $asset_textbox1 = $row_asset['asset_textbox1'];
                    $asset_textbox2 = $row_asset['asset_textbox2'];
                    $asset_textbox3 = $row_asset['asset_textbox3'];
                    $asset_textbox4 = $row_asset['asset_textbox4'];
                    $asset_textbox5 = $row_asset['asset_textbox5'];
                    $asset_textbox6 = $row_asset['asset_textbox6'];
                    $asset_textbox7 = $row_asset['asset_textbox7'];
                    $asset_textbox8 = $row_asset['asset_textbox8'];
                    $asset_textbox9 = $row_asset['asset_textbox9'];
                    $asset_textbox10 = $row_asset['asset_textbox10'];
                    $asset_textbox11 = $row_asset['asset_textbox11'];
                    $asset_textbox12 = $row_asset['asset_textbox12'];
                    $asset_textbox13 = $row_asset['asset_textbox13'];
                    $asset_textbox14 = $row_asset['asset_textbox14'];

                    $sav_textbox1 = $row_savings['sav_textbox1'];
                    $sav_textbox2 = $row_savings['sav_textbox2'];
                    $sav_textbox3 = $row_savings['sav_textbox3'];
                    $sav_textbox4 = $row_savings['sav_textbox4'];
                    $sav_textbox5 = $row_savings['sav_textbox5'];
                    $sav_textbox6 = $row_savings['sav_textbox6'];
                    $sav_textbox7 = $row_savings['sav_textbox7'];
                    $sav_textbox8 = $row_savings['sav_textbox8'];
                    $sav_textbox9 = $row_savings['sav_textbox9'];
                    $savings1 = $row_savings['savings1'];
                    $savings2 = $row_savings['savings2'];
                    $savings3 = $row_savings['savings3'];
                    $savings4 = $row_savings['savings4'];
                    $savings5 = $row_savings['savings5'];
                    $savings6 = $row_savings['savings6'];
                    $savings7 = $row_savings['savings7'];
                    $savings8 = $row_savings['savings8'];
                    $savings9 = $row_savings['savings9'];
                    ?>
                    <!-- /page header -->
                    <!-- Content area -->
                    <div class="content">
                                        ...
                                        <div class="col-md-12">
                                            <fieldset class="text-semibold">
                                                <div class="row">                                
                                                    ...
                                                    <div class="col-md-6">
                                                        <label class="radio-inline">
                                                            <input name="caste" id="caste" type="radio" <?php if (isset($caste) && $caste == "SC") echo "checked"; ?> value="SC">
                                                            SC
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input name="caste" id="caste" type="radio" <?php if (isset($caste) && $caste == "ST") echo "checked"; ?> value="ST">
                                                            ST
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input name="caste" id="caste" type="radio" <?php if (isset($caste) && $caste == "NT") echo "checked"; ?> value="NT">
                                                            NT
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input name="caste" id="caste" type="radio" <?php if (isset($caste) && $caste == "OBC") echo "checked"; ?> value="OBC">
                                                            OBC
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input name="caste" id="caste" type="radio" <?php if (isset($caste) && $caste == "Open/general") echo "checked"; ?> value="Open/general">
                                                            Open/general
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input name="caste" id="caste" type="radio" <?php if (isset($caste) && $caste == "No caste/refused to tell caste") echo "checked"; ?> value="No caste/refused to tell caste">
                                                            No caste/refused to tell caste
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input name="caste" id="caste" type="radio" <?php if (isset($caste) && $caste == "Don't know/Not sure") echo "checked"; ?> value="Don't know/Not sure">
                                                            Don't know/Not sure
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="radio">
                                                                <label class="radio-inline">
                                                                    <input name="povertyline" id="povertyline" type="radio" <?php if (isset($povertyline) && $povertyline == "Below poverty line(BPL)") echo "checked"; ?> value="Below poverty line(BPL)">
                                                                    Below poverty line(BPL) (Yellow ration card)
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input name="povertyline" id="povertyline" type="radio" <?php if (isset($povertyline) && $povertyline == "Above poverty line(APL)") echo "checked"; ?> value="Above poverty line(APL)">
                                                                    Above poverty line(APL) (Orange/ White ration card)
                                                                </label>
                                                                <br/>
                                                                <label class="radio-inline">
                                                                    <input name="povertyline" id="povertyline" type="radio" <?php if (isset($povertyline) && $povertyline == "Don't know/not sure") echo "checked"; ?> value="Don't know/not sure">
                                                                    Don't know/not sure
                                                                </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="radio">
                                                                <label class="radio-inline" for="availability">
                                                                    <input name="availability" type="radio" id="houseconstructed" <?php if (isset($availability) && $availability == "Constructed") echo "checked"; ?> value="Constructed">
                                                                    We own house (<b>Constructed</b> under Indira Awas Yojana (IAY))
                                                                </label>
                                                                <label class="radio-inline" for="availability">
                                                                    <input name="availability" type="radio" id="housenotconstructed" <?php if (isset($availability) && $availability == "Not Constructed") echo "checked"; ?> value="Not Constructed">
                                                                    We own house (<b>Not Constructed</b> under IAY)
                                                                </label>
                                                                <br/>
                                                                <label class="radio-inline" for="availability">
                                                                    <input name="availability" type="radio" id="renthouse" <?php if (isset($availability) && $availability == "Rent House") echo "checked"; ?> value="Rent House">
                                                                    We rent the house
                                                                </label>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row" id="house">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" name="housevalue" value="<?php echo $housevalue; ?>" class="form-control" placeholder="Rs.20000 to Rs.1500000" id="housevalue">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" id="house1">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" name="monthrent" value="<?php echo $monthrent; ?>" class="form-control" placeholder="Rs.1000 to Rs.10000" id="monthrent">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" name="buyfood" value="<?php echo $buyfood; ?>" class="form-control" placeholder="Rupees" id="buyfood">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="radio-inline" for="consumefood">
                                                                <input type="radio" name="consumefood" id="consumeNo" <?php if (isset($consumefood) && $consumefood == "No") echo "checked"; ?> value="No">
                                                                No
                                                            </label>
                                                            <label class="radio-inline" for="consumefood">
                                                                <input type="radio" name="consumefood" id="consumeYes" <?php if (isset($consumefood) && $consumefood == "Yes") echo "checked"; ?> value="Yes">
                                                                Yes
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row" id="quantity1">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" name="quantityoffood" value="<?php echo $quantityoffood; ?>" id="quantityoffood" class="form-control" placeholder="Rupees">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="radio-inline" for="receivedwages">
                                                                <input name="receivedwages" type="radio" id="wagesNo" <?php if (isset($receivedwages) && $receivedwages == "No") echo "checked"; ?> value="No">
                                                                No
                                                            </label>
                                                            <label class="radio-inline" for="receivedwages">
                                                                <input name="receivedwages" type="radio" id="wagesYes" <?php if (isset($receivedwages) && $receivedwages == "Yes") echo "checked"; ?> value="Yes">
                                                                Yes
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row" id="quantity2">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" name="costfood" value="<?php echo $costfood; ?>" id="costfood" class="form-control" placeholder="Rupees">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" id="observedrainfall">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="radio-inline">
                                                                <input name="rainfall" type="radio" id="rainfallLow" <?php if (isset($rainfall) && $rainfall == "Very low") echo "checked"; ?> value="Very low">
                                                                Very low 
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input name="rainfall" type="radio" id="rainfallNormal" <?php if (isset($rainfall) && $rainfall == "Normal") echo "checked"; ?> value="Normal">
                                                                Normal
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input name="rainfall" type="radio" id="rainfallMedium" <?php if (isset($rainfall) && $rainfall == "Medium") echo "checked"; ?> value="Medium">
                                                                Medium
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input name="rainfall" type="radio" id="rainfallHeavy" <?php if (isset($rainfall) && $rainfall == "Heavy") echo "checked"; ?> value="Heavy">
                                                                Heavy
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="radio-inline" for="migrated">
                                                                <input name="migrated" type="radio" id="migratedNo" <?php if (isset($migrated) && $migrated == "No") echo "checked"; ?> value="No">
                                                                No
                                                            </label>
                                                            <label class="radio-inline" for="migrated">
                                                                <input name="migrated" type="radio" id="migratedYes" <?php if (isset($migrated) && $migrated == "Yes") echo "checked"; ?> value="Yes">
                                                                Yes
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="radio-inline">
                                                                <input name="migrating" type="radio" <?php if (isset($migrating) && $migrating == "Low income from farming") echo "checked"; ?> value="Low income from farming">
                                                                Low income from farming
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input name="migrating" type="radio" <?php if (isset($migrating) && $migrating == "Limited livelihood sources") echo "checked"; ?> value="Limited livelihood sources">
                                                                Limited livelihood sources
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input name="migrating" type="radio" <?php if (isset($migrating) && $migrating == "Low rainfall") echo "checked"; ?> value="Low rainfall">
                                                                Low rainfall 
                                                            </label>
                                                            <label class="radio-inline">
                                                                Other
                                                            ...
                                                            <label class="form-group">
                                                                <input type="text" name="migrating" value="<?php echo $migrating; ?>" class="form-control" placeholder="If Other than Specify">
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" name="totalmembers" value="<?php echo $totalmembers; ?>" id="totalmembers" class="form-control" placeholder="Number of Members">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" name="totaltime" value="<?php echo $totaltime; ?>" id="totaltime" class="form-control" placeholder="Number of Times">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" name="totaldays" value="<?php echo $totaldays; ?>" id="totaldays" class="form-control" placeholder="Number of Days">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="radio-inline">
                                                                <input name="reducedtrips" type="radio" <?php if (isset($reducedtrips) && $reducedtrips == "Reduced") echo "checked"; ?> value="Reduced">
                                                                Reduced
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input name="reducedtrips" type="radio" <?php if (isset($reducedtrips) && $reducedtrips == "No change") echo "checked"; ?> value="No change">
                                                                No change
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input name="reducedtrips" type="radio" <?php if (isset($reducedtrips) && $reducedtrips == "Increased") echo "checked"; ?> value="Increased">
                                                                Increased
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="radio-inline">
                                                                <input name="reduceddays" type="radio" <?php if (isset($reduceddays) && $reduceddays == "Reduced") echo "checked"; ?> value="Reduced">
                                                                Reduced
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input name="reduceddays" type="radio" <?php if (isset($reduceddays) && $reduceddays == "No change") echo "checked"; ?> value="No change">
                                                                No change
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input name="reduceddays" type="radio" <?php if (isset($reduceddays) && $reduceddays == "Increased") echo "checked"; ?> value="Increased">
                                                                Increased
                                                            </label>
                                                        </div>
                                                    </div>
                                                                                ...
                                                                                if (mysql_num_rows($selectRes) == 0) {
                                                                                    ...
                                                                                    while ($row = mysql_fetch_assoc($selectRes)) {
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td id="expense_id"><input type="text" class="form-control" placeholder="Rupees" id="expense_id<?php echo expense_id; ?>" value="<?php echo $cost_per_year; ?>"> </td>
                                                                                            <?php
                                                                                            "</tr>\n";
                                                                                        }
                                                                                    }
                                                                                ...
                                                                                if (mysql_num_rows($selectRes) == 0) {
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="form-group">
                                                                                            <select name="income<?php echo $row['income_id']; ?>" class="form-control">
                                                                                                <option value="<?php echo $income1; ?>"><?php echo $income1; ?></option>
                                                                                    ...
                                                                                    <td><input type="number" id="<?php echo $row['income_id']; ?>" class="form-control incomebox1<?php echo $row['income_id']; ?>" placeholder="Rupees Earned" name="income_textbox<?php echo $row['income_id']; ?>"/>
                                                                                        ...
                                                                                        if ($row['income_id'] == 1) {
                                                                                            ...
                                                                                            ?>
                                                                                            <p class="hint<?php echo $row['income_id']; ?>" value="<?php echo $income_textbox6; ?>">Hint Give Range (1000 to 300000)</p>
                                                                                            <?php
                                                                                        } elseif ($row['income_id'] == 7) {
                                                                                            ?>
                                                                                            <p class="hint<?php echo $row['income_id']; ?>" value="<?php echo $income_textbox7; ?>">Hint Give Range (1000 to 300000)</p>
                                                                                            <?php
                                                                                        } elseif ($row['income_id'] == 8) {
                                                                                            ?>
                                                                                            <p class="hint<?php echo $row['income_id']; ?>" value="<?php echo $income_textbox8; ?>">Hint Give Range (1000 to 300000)</p>
                                                                                            <?php
                                                                                        } elseif ($row['income_id'] == 9) {
                                                                                            ?>
                                                                                            <p class="hint<?php echo $row['income_id']; ?>" value="<?php echo $income_textbox9; ?>">Hint Give Range (1000 to 300000)</p>
                                                                                            <?php
                                                                                        } elseif ($row['income_id'] == 10) {
                                                                                            ?>
                                                                                            <p class="hint<?php echo $row['income_id']; ?>" value="<?php echo $income_textbox10; ?>">Hint Give Range (1000 to 300000)</p>
                                                                                            <?php
                                                                                        } elseif ($row['income_id'] == 11) {
                                                                                            ?>
                                                                                            <p class="hint<?php echo $row['income_id']; ?>" value="<?php echo $income_textbox11; ?>">Hint Give Range (1000 to 100000)</p>
                                                                                            <?php
                                                                                        } elseif ($row['income_id'] == 12) {
                                                                                            ?>
                                                                                            <p class="hint<?php echo $row['income_id']; ?>" value="<?php echo $income_textbox12; ?>">Hint Give Range (1000 to 300000)</p>
                                                                                            <?php
                                                                                        } elseif ($row['income_id'] == 13) {
                                                                                            ?>
                                                                                            <p class="hint<?php echo $row['income_id']; ?>" value="<?php echo $income_textbox13; ?>">Hint Give Range (1000 to 300000)</p>
                                                                                            <?php
                                                                                        } elseif ($row['income_id'] == 14) {
                                                                                            ?>
                                                                                            <p class="hint<?php echo $row['income_id']; ?>" value="<?php echo $income_textbox14; ?>">Hint Give Range (1000 to 300000)</p>
                                                                                            <?php
                                                                                        }
                                                                                        ?>                                                                                        
                                                                                    </td>                                                                                    
